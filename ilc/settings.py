...
DATABASES = {
    'default': {
        ...
        'NAME': 'ilc.db',                      # Or path to database file if using sqlite3.
        'USER': '',                      # Not used with sqlite3.
        'PASSWORD': '',                  # Not used with sqlite3.
        'HOST': '',                      # sSet to empty string for localhost. Not used with sqlite3.
...
SECRET_KEY = 'n-lmosy3+i1fkbq-5v4rp^4k@on1hcwmc^rglge8)h7l8pi36u'
